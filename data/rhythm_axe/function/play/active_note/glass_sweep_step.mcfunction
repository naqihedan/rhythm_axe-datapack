...
execute at @s positioned ~-0.75 ~-0.75 ~-0.75 if entity @a[dx=0,dy=0,dz=0] positioned ~0.5 ~0.5 ~0.5 if entity @a[dx=0,dy=0,dz=0] run function rhythm_axe:play/judgement_feedback/damage
