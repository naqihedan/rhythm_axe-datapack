# 偏移量右移一小节：offset += tick_per_beat * beat_per_bar
...
# 总长度分数项变更 + 值域钳制
scoreboard players operation calc editor = tick_per_beat editor
scoreboard players operation calc editor *= beat_per_bar editor
scoreboard players operation old_offset editor = offset editor
scoreboard players operation offset editor += calc editor
