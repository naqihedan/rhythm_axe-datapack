...
$execute if data storage rhythm_axe:feedback sounds[$(gf_hs)].$(gf_case) run data modify storage rhythm_axe:editor.runtime cur_sound set from storage rhythm_axe:feedback sounds[$(gf_hs)].$(gf_case)
...
$execute if data storage rhythm_axe:feedback particles[$(gf_hp)].$(gf_case) run data modify storage rhythm_axe:editor.runtime cur_particle set from storage rhythm_axe:feedback particles[$(gf_hp)].$(gf_case)
...
# ---- hit_events：editor_note_hitevents=1 时，复制该音符的 hit_events 并按 case 跑 ----
$execute if score editor_note_hitevents options matches 1 run data modify storage rhythm_axe:editor.runtime case_name set value "$(gf_case)"
$execute if score editor_note_hitevents options matches 1 if data storage rhythm_axe:maps.editor history[$(gf_cursor)].notes[$(gf_idx)].hit_events run data modify storage rhythm_axe:editor.runtime hit_events.$(gf_nid) set from storage rhythm_axe:maps.editor history[$(gf_cursor)].notes[$(gf_idx)].hit_events
$execute if score editor_note_hitevents options matches 1 unless data storage rhythm_axe:maps.editor history[$(gf_cursor)].notes[$(gf_idx)].hit_events run data modify storage rhythm_axe:editor.runtime hit_events.$(gf_nid) set value []
$execute if score editor_note_hitevents options matches 1 run data modify storage rhythm_axe:editor.runtime fb_nid set value $(gf_nid)
