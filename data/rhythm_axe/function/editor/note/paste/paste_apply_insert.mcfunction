...
$execute if data storage rhythm_axe:prop paste_select run data modify storage rhythm_axe:maps.editor history[$(cursor)].notes[$(insert_index)].selected set value 1b
