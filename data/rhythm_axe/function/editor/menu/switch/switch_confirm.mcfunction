...
# 值段：911 保存并切换 / 912 丢弃并切换 / 913 编辑新谱面 / 903 继续编辑当前谱面
...
{"text":"【保存当前谱面并开始编辑新谱面】","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 911"},"hover_event":{"action":"show_text","value":"保存当前谱面后打开新谱面"}},\
{"text":"  【丢弃当前谱面改动并且开始编辑新谱面】","color":"red","click_event":{"action":"run_command","command":"/trigger editor_click set 912"},"hover_event":{"action":"show_text","value":"不保存当前改动，直接打开新谱面"}},\
...
{"text":"【编辑新谱面】","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 913"},"hover_event":{"action":"show_text","value":"直接打开新谱面"}},\
{"text":"  【继续编辑当前谱面】","color":"gray","click_event":{"action":"run_command","command":"/trigger editor_click set 903"},"hover_event":{"action":"show_text","value":"回到当前谱面编辑器"}}\
]
