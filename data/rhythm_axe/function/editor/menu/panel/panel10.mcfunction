...
#   翻转组沿用固定值 909(翻转时间) / 910,914,915,916(X/Y/Z/S 开关) / 917(执行翻转)（面板 10/18 共用）
# note_list_open 设 current_panel=10。本面板刷新用 note_list_*。
# 入口白名单守卫
execute unless score #click_value editor matches 1 unless score #click_value editor matches 100000..103999 unless score #click_value editor matches 11301..11305 unless score #click_value editor matches 11601..11602 unless score #click_value editor matches 909 unless score #click_value editor matches 910 unless score #click_value editor matches 914..917 run function rhythm_axe:editor/menu/wrong_panel
execute unless score #click_value editor matches 1 unless score #click_value editor matches 100000..103999 unless score #click_value editor matches 11301..11305 unless score #click_value editor matches 11601..11602 unless score #click_value editor matches 909 unless score #click_value editor matches 910 unless score #click_value editor matches 914..917 run return fail
