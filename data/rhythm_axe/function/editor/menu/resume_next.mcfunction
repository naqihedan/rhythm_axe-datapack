...
execute as @a[tag=editor_lock_holder,limit=1] run function rhythm_axe:editor/menu/resume
execute unless entity @a[tag=editor_lock_holder] as @a[tag=editor_active,limit=1] run function rhythm_axe:editor/menu/resume
