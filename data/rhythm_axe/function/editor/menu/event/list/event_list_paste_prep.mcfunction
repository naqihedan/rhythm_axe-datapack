# 事件列表【粘贴】前置：点击值 421+页内序号 → prop.index
...
scoreboard players remove #temp_cursor editor 421
scoreboard players operation #temp editor += #temp_cursor editor
data modify storage rhythm_axe:prop cursor set from storage rhythm_axe:maps.editor history_cursor
execute store result storage rhythm_axe:prop index int 1 run scoreboard players get #temp editor
function rhythm_axe:editor/menu/event/list/event_list_paste_ with storage rhythm_axe:prop
