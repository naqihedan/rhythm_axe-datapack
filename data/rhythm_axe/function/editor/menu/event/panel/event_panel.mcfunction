...
{"text":"时间：","color":"gray"},\
{"text":"[-]","color":"red","click_event":{"action":"run_command","command":"/trigger editor_click set 10400"},"hover_event":{"action":"show_text","value":"最少 0 刻"}},\
{"nbt":"editing.temp.time","storage":"rhythm_axe:maps.editor","color":"white"},\
{"text":" [+] ","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10401"},"hover_event":{"action":"show_text","value":"时间 +1 刻"}},\
{"text":"【使用当前时间】","color":"yellow","click_event":{"action":"run_command","command":"/trigger editor_click set 10490"},"hover_event":{"action":"show_text","value":"时间设为播放头位置"}}\
]
execute if score #temp editor matches 1.. run tellraw @s [\
{"text":"时间：","color":"gray"},\
{"text":"[-]","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10400"},"hover_event":{"action":"show_text","value":"时间 -1 刻"}},\
{"nbt":"editing.temp.time","storage":"rhythm_axe:maps.editor","color":"white"},\
{"text":" [+] ","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10401"},"hover_event":{"action":"show_text","value":"时间 +1 刻"}},\
{"text":"【使用当前时间】","color":"yellow","click_event":{"action":"run_command","command":"/trigger editor_click set 10490"},"hover_event":{"action":"show_text","value":"时间设为播放头位置"}}\
]
...
{"text":"【取消】","color":"red","click_event":{"action":"run_command","command":"/trigger editor_click set 10403"},"hover_event":{"action":"show_text","value":"丢弃修改并返回列表"}},\
{"text":"  【确认新增】","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10406"},"hover_event":{"action":"show_text","value":"在指定时间新增事件点"}},\
{"text":"  【复制】","color":"aqua","click_event":{"action":"run_command","command":"/trigger editor_click set 10491"},"hover_event":{"action":"show_text","value":"复制正在编辑的事件信息"}},\
{"text":"  【粘贴】","color":"yellow","click_event":{"action":"run_command","command":"/trigger editor_click set 10492"},"hover_event":{"action":"show_text","value":"粘贴剪贴板信息到正在编辑的事件"}}\
]
