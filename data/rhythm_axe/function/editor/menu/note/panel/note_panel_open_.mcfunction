...
data modify storage rhythm_axe:maps.editor editing.rel set value {on:{time:0b,size:0b,position:0b,start_pos:0b,duration:0b,base_life:0b},delta:{time:0,size:0,position:[0,0,0],start_pos:[0,0,0],duration:0,base_life:0}}
