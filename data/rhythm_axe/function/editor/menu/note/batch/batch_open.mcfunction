...
#   表现为「批量编辑面板里基础寿命那行不是默认相对」。
data modify storage rhythm_axe:maps.editor editing.rel set value {on:{time:1b,size:1b,position:1b,start_pos:1b,duration:1b,base_life:1b},delta:{time:0,size:0,position:[0,0,0],start_pos:[0,0,0],duration:0,base_life:0}}
