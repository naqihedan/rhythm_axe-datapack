...
tellraw @s [\
{"text":"【0】","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10001"},"hover_event":{"action":"show_text","value":"查看组 0"}},\
{"text":"【1】","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10101"},"hover_event":{"action":"show_text","value":"查看组 1"}},\
