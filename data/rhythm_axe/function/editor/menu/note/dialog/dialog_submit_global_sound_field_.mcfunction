#arg:gv_value,gv_group,gv_case
# 执行宏：写回 feedback.sounds[sound_group].sound_case 并刷新全局音效详情
$data modify storage rhythm_axe:feedback sounds[$(gv_group)].$(gv_case) set value "$(gv_value)"
