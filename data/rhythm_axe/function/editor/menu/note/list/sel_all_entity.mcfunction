...
execute if score #sel_on editor matches 0 run execute store result storage rhythm_axe:prop nid int 1 run scoreboard players get @s note_id
execute if score #sel_on editor matches 0 run data modify storage rhythm_axe:maps.editor selection append from storage rhythm_axe:prop nid
execute if score #sel_on editor matches 0 run data remove storage rhythm_axe:prop nid
