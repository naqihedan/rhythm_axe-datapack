...
# 复选框 toggle 点击值
execute if score #show_row editor matches 1 run scoreboard players operation #temp editor = #note_alive editor
execute if score #show_row editor matches 1 run scoreboard players add #temp editor 1599
