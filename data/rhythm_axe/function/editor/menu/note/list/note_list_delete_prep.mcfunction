# 音符列表【删除】前置：点击值 720+存活序 → 按存活序找数组索引 → 删除
...
scoreboard players remove #temp_cursor editor 720
scoreboard players operation #temp editor += #temp_cursor editor
...
function rhythm_axe:editor/menu/note/list/note_list_delete_ with storage rhythm_axe:prop
