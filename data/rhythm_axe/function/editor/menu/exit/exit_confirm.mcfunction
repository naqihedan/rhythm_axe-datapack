...
tellraw @s [\
{"text":"【保存并退出】","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 901"},"hover_event":{"action":"show_text","value":"保存谱面后退出"}},\
{"text":"  【不保存并退出】","color":"red","click_event":{"action":"run_command","command":"/trigger editor_click set 902"},"hover_event":{"action":"show_text","value":"丢弃未保存的修改并退出"}},\
