...
{"text":"[-]","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10701"},"hover_event":{"action":"show_text","value":"X -0.1"}},\
{"score":{"name":"#vxi","objective":"editor"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#vxf","objective":"editor"},"color":"gold"},\
{"text":" [+]","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10702"},"hover_event":{"action":"show_text","value":"X +0.1"}},\
{"text":"  [-]","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10703"},"hover_event":{"action":"show_text","value":"Y -0.1"}},\
{"score":{"name":"#vyi","objective":"editor"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#vyf","objective":"editor"},"color":"gold"},\
{"text":" [+]","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10704"},"hover_event":{"action":"show_text","value":"Y +0.1"}},\
{"text":"  [-]","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10705"},"hover_event":{"action":"show_text","value":"Z -0.1"}},\
{"score":{"name":"#vzi","objective":"editor"},"color":"gold"},{"text":".","color":"gold"},{"score":{"name":"#vzf","objective":"editor"},"color":"gold"},\
{"text":" [+]","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 10706"},"hover_event":{"action":"show_text","value":"Z +0.1"}}\
]
