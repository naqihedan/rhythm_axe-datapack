#arg: index
# 回收站行：{标题}-{作者}-{mapid}【还原】【彻底删除】；上限 10 行（按钮值 1380/1390 + index）
...
$tellraw @s ["",{"nbt":"trash[$(index)].title","storage":"rhythm_axe:maps","interpret":true,"color":"aqua"},{"text":" - ","color":"gray"},{"nbt":"trash[$(index)].artist","storage":"rhythm_axe:maps","interpret":true,"color":"aqua"},{"text":" - ","color":"gray"},{"nbt":"trash[$(index)].mapid","storage":"rhythm_axe:maps","color":"aqua"},{"text":"  ","color":"gray"},{"text":"【还原】","color":"green","click_event":{"action":"run_command","command":"/trigger editor_click set 138$(index)"},"hover_event":{"action":"show_text","value":"把谱面恢复到正式存储"}},{"text":"【彻底删除】","color":"red","click_event":{"action":"run_command","command":"/trigger editor_click set 139$(index)"},"hover_event":{"action":"show_text","value":"从回收站永久删除"}}]
