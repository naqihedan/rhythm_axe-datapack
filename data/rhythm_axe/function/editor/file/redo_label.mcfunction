#arg:cursor
# 重做标签：labels[cursor]（字符串）读不到则用 last_label 兜底
...
execute if data storage rhythm_axe:prop lb run function rhythm_axe:editor/file/redo_label_go with storage rhythm_axe:prop
