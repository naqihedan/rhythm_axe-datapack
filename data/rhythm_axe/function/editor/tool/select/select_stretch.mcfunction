#arg:cx_int,cy_int,cz_int,nx,ny,nz,glow_sel
...
$data modify entity @e[tag=$(glow_sel),limit=1] Pos[0] set from entity @e[tag=editor_tool_sel_anchor,limit=1] Pos[0]
$data modify entity @e[tag=$(glow_sel),limit=1] Pos[1] set from entity @e[tag=editor_tool_sel_anchor,limit=1] Pos[1]
$data modify entity @e[tag=$(glow_sel),limit=1] Pos[2] set from entity @e[tag=editor_tool_sel_anchor,limit=1] Pos[2]
kill @e[tag=editor_tool_sel_anchor]
$data modify entity @e[tag=$(glow_sel),limit=1] transformation.scale set value [$(nx),$(ny),$(nz)]
