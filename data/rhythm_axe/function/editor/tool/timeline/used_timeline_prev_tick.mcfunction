...
# 执行工具命令：站立=快退一刻(22)，蹲下=快进一刻(24)
execute unless entity @s[predicate=rhythm_axe:sneaking] run trigger editor_click set 22
execute if entity @s[predicate=rhythm_axe:sneaking] run trigger editor_click set 24
