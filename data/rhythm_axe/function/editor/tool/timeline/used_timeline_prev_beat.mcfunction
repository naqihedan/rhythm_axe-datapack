...
# 执行工具命令：站立=快退一拍(21)，蹲下=快进一拍(25)
execute unless entity @s[predicate=rhythm_axe:sneaking] run trigger editor_click set 21
execute if entity @s[predicate=rhythm_axe:sneaking] run trigger editor_click set 25
